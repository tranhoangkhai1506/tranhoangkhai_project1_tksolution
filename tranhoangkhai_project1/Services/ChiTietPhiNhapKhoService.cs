...
namespace tranhoangkhai_project1.Services
{
    public class ChiTietPhiNhapKhoService : iChiTietPhieuNhapKhoService
    {
        ...
        public async Task DeleteChiTietPhieuNhapAsync(string Nhap_Kho_ID, int San_Pham_ID)
        {
        ...
        public async Task<ChiTietPhieuNhapKho> GetByIdAsync(string Nhap_Kho_ID, int San_Pham_ID)
        {
            var chiTietPhieuNhapKho = await _dataContext.tbl_DM_Nhap_Kho_Raw_Data.FirstOrDefaultAsync(p => p.Nhap_Kho_ID.Equals(Nhap_Kho_ID) && p.San_Pham_ID == San_Pham_ID);
        ...
        public async Task UpdateChiTietPhieuNhapAsync(ChiTietPhieuNhapKho chitietPHK, string Nhap_Kho_ID, int San_Pham_ID)
        {
            var dbChiTietPhieuNhapKho = await _dataContext.tbl_DM_Nhap_Kho_Raw_Data.FirstOrDefaultAsync(p => p.Nhap_Kho_ID.Equals(Nhap_Kho_ID) && p.San_Pham_ID == San_Pham_ID);
